 ...
 */
export declare function getAutomationWithQuery(id: string, query: Record<string, unknown>, options?: ApiCallOptions): Promise<GetAutomationWithQueryHttpResponse>;
export type GetAutomationWithQueryHttpResponse = {
  data: AutomationDetailResponseObject;
  headers: Headers;
  status: 200;
};
export type GetAutomationWithQueryHttpError = {
  data: ErrorResponse;
  headers: Headers;
 ...
 */
export declare function queueAutomationRun(id: string, body: RunDetailRequestObject, options?: ApiCallOptions): Promise<QueueAutomationRunHttpResponse>;
export type QueueAutomationRunHttpResponse = {
  data: RunDetailResponseObject;
  headers: Headers;
  status: 201;
};
export type QueueAutomationRunHttpError = {
  data: ErrorResponse;
  headers: Headers;
  status: 400 | 401 | 403 | 404 | 500 | 503;
};
 ...
 */
export declare function getAutomationRunWithQuery(id: string, runId: string, query: Record<string, unknown>, options?: ApiCallOptions): Promise<GetAutomationRunWithQueryHttpResponse>;
export type GetAutomationRunWithQueryHttpResponse = {
  data: RunDetailResponseObject;
  headers: Headers;
  status: 200;
};
export type GetAutomationRunWithQueryHttpError = {
  data: ErrorResponse;
  headers: Headers;
  status: 400 | 401 | 403 | 404 | 500 | 503;
};
 ...
 */
export declare function getAutomationRunDetails(id: string, runId: string, options?: ApiCallOptions): Promise<GetAutomationRunDetailsHttpResponse>;
export type GetAutomationRunDetailsHttpResponse = {
  data: {
    url?: string;
  };
  headers: Headers;
...
export type GetAutomationRunDetailsHttpError = {
  data: ErrorResponse;
  headers: Headers;
  status: 400 | 401 | 403 | 404 | 500 | 503;
};
...
//#endregion
export { automationsExport as default };