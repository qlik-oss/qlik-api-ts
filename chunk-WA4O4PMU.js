...
async function invokeFetch(api, props) {
  ...
  return (await _chunkL4SFSITJjs.getInvokeFetchRuntimeModule.call(void 0, hostConfig)).invokeFetch(api, props);
}
function clearApiCache(api) {
  void _chunkL4SFSITJjs.getInvokeFetchRuntimeModule.call(void 0, ).then((runtimeModule) => runtimeModule.clearApiCache(api));
}
