...
var getReloads = async (query, options) => _chunkQQDHWGJXjs.invokeFetch.call(void 0, "reloads", {
  method: "get",
  pathTemplate: "/api/v1/reloads",
  query,
  options
});
var queueReload = async (body, options) => _chunkQQDHWGJXjs.invokeFetch.call(void 0, "reloads", {
  method: "post",
  pathTemplate: "/api/v1/reloads",
  body,
...
var getReload = async (reloadId, options) => _chunkQQDHWGJXjs.invokeFetch.call(void 0, "reloads", {
  method: "get",
  pathTemplate: "/api/v1/reloads/{reloadId}",
  pathVariables: { reloadId },
  options
});
var cancelReload = async (reloadId, options) => _chunkQQDHWGJXjs.invokeFetch.call(void 0, "reloads", {
  method: "post",
...
function clearCache() {
  return _chunkQQDHWGJXjs.clearApiCache.call(void 0, "reloads");
}
