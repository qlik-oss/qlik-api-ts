import { i as isNode$1 } from "./utils-6sNODUN0.js";
...
const importRuntimeModulePromise = (async () => {
	...
	return (await import("./dist-Df-Traut.js")).importRuntimeModule;
})();
/**
* @param hostConfig
* @returns
