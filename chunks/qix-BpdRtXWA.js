...
import { A as getPlatform, C as invokeFetch, g as toValidWebsocketLocationUrl, l as isWindows, s as handleAuthenticationError } from "./auth-functions-C27LB1gE.js";
...
async function createAndSetupEnigmaSession(props, canRetry, onWebSocketEvent$1) {
	const { createEnigmaSessionEntrypoint } = await import("./qix-chunk-entrypoint-C_zIcxOU.js");
...
function createSharedPhoenixSession(props, { onClose, onWebSocketEvent: onWebSocketEventGlobal, getInitialAppActions }) {
	try {
		...
		const phoenixConnectionPromise = import("./qix-chunk-entrypoint-C_zIcxOU.js").then((module) => {
