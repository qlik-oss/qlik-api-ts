...
import { D as toValidWebsocketLocationUrl, P as invokeFetch, V as getPlatform, g as isWindows, m as handleAuthenticationError } from "./interceptors-DIpfevKZ.js";
...
async function createAndSetupEnigmaSession(props, canRetry, onWebSocketEvent, progressMonitor) {
	const { createEnigmaSessionEntrypoint } = await import("./qix-chunk-entrypoint-CJcF-WMq.js");
...
function createSharedPhoenixSession(props, { onClose, onWebSocketEvent: onWebSocketEventGlobal, getInitialAppActions }) {
	try {
		...
		const phoenixConnectionPromise = import("./qix-chunk-entrypoint-CJcF-WMq.js").then((module) => {
