...
import { I as getPlatform, S as toValidWebsocketLocationUrl, h as isWindows, k as invokeFetch, p as handleAuthenticationError } from "./interceptors-BeHmFB2L.js";
...
async function createAndSetupEnigmaSession(props, canRetry, onWebSocketEvent$1) {
	const { createEnigmaSessionEntrypoint } = await import("./qix-chunk-entrypoint-DLk9SmCw.js");
...
function createSharedPhoenixSession(props, { onClose, onWebSocketEvent: onWebSocketEventGlobal, getInitialAppActions }) {
	try {
		...
		const phoenixConnectionPromise = import("./qix-chunk-entrypoint-DLk9SmCw.js").then((module) => {
