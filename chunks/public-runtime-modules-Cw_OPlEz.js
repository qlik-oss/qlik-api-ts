...
const importRuntimeModulePromise = (async () => {
	...
	return (await import("./dist-CKkIPLEp.js")).importRuntimeModule;
})();
/**
* @param hostConfig
* @returns
