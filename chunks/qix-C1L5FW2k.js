...
import { getPlatform, handleAuthenticationError, invokeFetch, isWindows, toValidWebsocketLocationUrl } from "./auth-functions-ClrPAf4t.js";
...
async function createAndSetupEnigmaSession(props, canRetry, onWebSocketEvent$1) {
	const { createEnigmaSessionEntrypoint } = await import("./qix-chunk-entrypoint-DhIaGj-U.js");
...
function createSharedPhoenixSession(props, { onClose, onWebSocketEvent: onWebSocketEventGlobal, getInitialAppActions }) {
	try {
		...
		const phoenixConnectionPromise = import("./qix-chunk-entrypoint-DhIaGj-U.js").then((module) => {
