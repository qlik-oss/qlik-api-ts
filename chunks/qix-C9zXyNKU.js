...
import { A as getPlatform, C as invokeFetch, g as toValidWebsocketLocationUrl, l as isWindows, s as handleAuthenticationError } from "./auth-functions-RwRVWEF6.js";
...
async function createAndSetupEnigmaSession(props, canRetry, onWebSocketEvent$1) {
	const { createEnigmaSessionEntrypoint } = await import("./qix-chunk-entrypoint-a9O22ha6.js");
...
function createSharedPhoenixSession(props, { onClose, onWebSocketEvent: onWebSocketEventGlobal, getInitialAppActions }) {
	try {
		...
		const phoenixConnectionPromise = import("./qix-chunk-entrypoint-a9O22ha6.js").then((module) => {
