...
import { B as getPlatform, E as toValidWebsocketLocationUrl, N as invokeFetch, h as isWindows, p as handleAuthenticationError } from "./interceptors-CJ5KSs4l.js";
...
async function createAndSetupEnigmaSession(props, canRetry, onWebSocketEvent) {
	const { createEnigmaSessionEntrypoint } = await import("./qix-chunk-entrypoint-B-QQpO2G.js");
...
function createSharedPhoenixSession(props, { onClose, onWebSocketEvent: onWebSocketEventGlobal, getInitialAppActions }) {
	try {
		...
		const phoenixConnectionPromise = import("./qix-chunk-entrypoint-B-QQpO2G.js").then((module) => {
