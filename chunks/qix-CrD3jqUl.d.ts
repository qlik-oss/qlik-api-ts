import { d as HostConfig } from "./auth-types-CMYVHKHt.js";

//#region src/qix/types/engine-schema.d.ts
declare const QIX_SCHEMA_VERSION = "12.2575.0";
type AlfaNumString = {
  /**
   * Calculated value.
   */
