...
const coreBootInterceptor = async (request, proceed) => {
	...
	if (hostConfig?.authType === "noauth" || await isWindows(hostConfig)) return proceed(request);
	const serializedHostConfig = serializeHostConfig(request.options?.hostConfig);
...
//#endregion
export { parseFetchResponse as A, unregisterHostConfig$1 as C, UnexpectedAuthTypeError as D, InvalidHostConfigError as E, generateRandomString as F, getPlatform as I, EncodingError as M, InvokeFetchError as N, clearApiCache as O, exposeInternalApiOnWindow as P, toValidWebsocketLocationUrl as S, InvalidAuthTypeError as T, registerAuthModule$1 as _, interceptors_default as a, setDefaultHostConfig$1 as b, getAccessToken as c, getWebResourceAuthParams as d, getWebSocketAuthParams as f, logout as g, isWindows as h, getInterceptors as i, appendQueryToUrl as j, invokeFetch as k, getDefaultHostConfig$1 as l, isHostCrossOrigin as m, addInterceptor as n, removeInterceptor as o, handleAuthenticationError as p, createInterceptors as r, determineAuthType$1 as s, addDefaultInterceptors as t, getRestCallAuthParams as u, registerHostConfig$1 as v, AuthorizationError as w, toValidLocationUrl as x, serializeHostConfig$1 as y };