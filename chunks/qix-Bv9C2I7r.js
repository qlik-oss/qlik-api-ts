...
import { B as getPlatform, E as toValidWebsocketLocationUrl, N as invokeFetch, h as isWindows, p as handleAuthenticationError } from "./interceptors-Ce5-8eIE.js";
...
async function createAndSetupEnigmaSession(props, canRetry, onWebSocketEvent) {
	const { createEnigmaSessionEntrypoint } = await import("./qix-chunk-entrypoint-7eFJDyM5.js");
...
function createSharedPhoenixSession(props, { onClose, onWebSocketEvent: onWebSocketEventGlobal, getInitialAppActions }) {
	try {
		...
		const phoenixConnectionPromise = import("./qix-chunk-entrypoint-7eFJDyM5.js").then((module) => {
