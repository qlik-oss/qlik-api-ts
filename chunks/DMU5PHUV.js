...
async function invokeFetch(api, props) {
  ...
  return (await _MBVF2FVPjs.getInvokeFetchRuntimeModule.call(void 0, hostConfig)).invokeFetch(api, props);
}
function clearApiCache(api) {
  void _MBVF2FVPjs.getInvokeFetchRuntimeModule.call(void 0, ).then((runtimeModule) => runtimeModule.clearApiCache(api));
}
