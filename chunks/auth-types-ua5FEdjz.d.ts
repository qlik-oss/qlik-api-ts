...
type WindowsCookieAuthConfig = {
  ...
  crossSiteCookies?: boolean;
  /**
   * A custom function that can be used on the client side to fetch a windows auth jwt from a custom backend.
...
//#endregion
export { ApiCallOptions, AuthModule, AuthType, AuthTypeThatCanBeOmitted, AuthenticationErrorAction, CacheEntry, CacheOptions, Credentials, DownloadableBlob, GetRemoteAuthDataProps, GetRestCallAuthParamsProps, GetWebResourceAuthParamsProps, GetWebSocketAuthParamsProps, HandleAuthenticationErrorProps, HostConfig, HostConfigCommon, InvokeFetchProperties, InvokeFetchResponse, PartialProgressEvent, PerformInteractiveLoginFn, ProgressOptions, RestCallAuthParams, WebResourceAuthParams, WebSocketAuthParams, _default, authTypesThatCanBeOmitted, hostConfigCommonProperties };