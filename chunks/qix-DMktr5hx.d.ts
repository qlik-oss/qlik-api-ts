...
declare const QIX_SCHEMA_VERSION = "12.2840.0";
type AlfaNumString = {
  /**
   * Calculated value.
   */
...
//#endregion
export { ListBoxProperties as $, NxVariableListItem as $a, NxLibraryMeasure as $i, GenericDimensionLayout as $n, SelectionObject as $o, NxAutoSortByStateDef as $r, CyclicGroupPosition as $t, GenericObject as A, NxSelectionCell as Aa, NxFieldDescription as Ai, FieldDefEx as An, SearchFieldMatchType as Ao, LogOnType as Ar, UndoInfoDef as As, Blob as At, GenericObjectPropertiesNodeLevel4 as B, NxTempBookmarkOptions as Ba, NxGroupMemberClass as Bi, FileDataFormat as Bn, SearchGroupType as Bo, NativeGenericMeasureFunctions as Br, BookmarkStateFieldPages as Bt, CurrentSelections as C, NxPatchOperationType as Ca, NxDimensionType as Ci, ExtendedLayoutBookmarkData as Cn, SearchAssociationResult as Co, LayoutBookmarkData as Cr, TextMacro as Cs, ApplyGroupStateWarningType as Ct, GenericDimension as D, NxPivotValuePoint as Da, NxExportFileType as Di, FailureData as Dn, SearchContextType as Do, ListObject as Dr, TreeData as Ds, BNFDef as Dt, GenericBookmark as E, NxPivotPage as Ea, NxEngineVersion as Ei, ExtensionListDef as En, SearchCombinationOptions as Eo, LineageInfo as Er, TransformAppResult as Es, AssociationScore as Et, GenericObjectLayoutNodeLevel5 as F, NxSortIndicatorType as Fa, NxFieldTableResourceId as Fi, FieldListDef as Fn, SearchGroupItem as Fo, MetaData as Fr, VariableListDef as Fs, BookmarkFieldPageEx as Ft, RpcObject as G, NxTreeMultiRangeSelectInfo as Ga, NxHypercubeMode as Gi, FolderItemType as Gn, SearchResult as Go, NxAppLayout as Gr, ChildList as Gt, GenericObjectPropertiesNodeRec as H, NxTreeDataOption as Ha, NxGroupTail as Hi, FilterInfo as Hn, SearchMatchCombinations as Ho, NativeGenericVariableFunctions as Hr, CalendarStrings as Ht, GenericObjectLayoutNodeRec as I, NxStackPage as Ia, NxFrequencyMode as Ii, FieldOrColumn as In, SearchGroupItemMatch as Io, NativeDocFunctions as Ir, BookmarkFieldVerifyResultState as It, DimensionListData as J, NxTreeValue as Ja, NxInlineMeasureDef as Ji, GenericBookmarkEntry as Jn, SearchTermResult as Jo, NxAttrDimInfo as Jr, CondDef as Jt, BookmarkListData as K, NxTreeNode as Ka, NxInfo as Ki, FrequencyDistributionData as Kn, SearchSuggestItem as Ko, NxAppProperties as Kr, ChildListDef as Kt, GenericObjectPropertiesNode as L, NxStackedPivotCell as La, NxGetBookmarkOptions as Li, FieldScores as Ln, SearchGroupItemOptions as Lo, NativeFieldFunctions as Lr, BookmarkFieldVerifyWarning as Lt, GenericObjectLayoutNodeLevel2 as M, NxSelectionInfo as Ma, NxFieldResourceId as Mi, FieldInTableData as Mn, SearchFieldSelectionMode as Mo, MeasureListDef as Mr, ValueExpr as Ms, BookmarkApplyAndVerifyResult as Mt, GenericObjectLayoutNodeLevel3 as N, NxSimpleDimValue as Na, NxFieldSelectionInfo as Ni, FieldInTableProfilingData as Nn, SearchFieldValueItem as No, MediaListDef as Nr, ValueExpression as Ns, BookmarkFieldItem as Nt, GenericListObject as O, NxRange as Oa, NxExportState as Oi, FieldAttrType as On, SearchFieldDictionary as Oo, ListObjectDef as Or, TreeDataDef as Os, BNFDefMetaType as Ot, GenericObjectLayoutNodeLevel4 as P, NxSimpleValue as Pa, NxFieldSelectionMode as Pi, FieldList as Pn, SearchGroup as Po, MediaListItem as Pr, VariableList as Ps, BookmarkFieldPage as Pt, ExpandedFieldListItem as Q, NxValidationError as Qa, NxLibraryDimensionDef as Qi, GenericDimensionInfo as Qn, SelectInfo as Qo, NxAttributeExpressionValues as Qr, CustomConnector as Qt, GenericObjectPropertiesNodeLevel2 as R, NxStateCounts as Ra, NxGetObjectOptions as Ri, FieldType as Rn, SearchGroupItemType as Ro, NativeGenericBookmarkFunctions as Rr, BookmarkList as Rt, AnyGenericObjectProperties as S, NxPatch as Sa, NxDimensionInfo as Si, ExpansionData as Sn, ScrollPosition as So, KeyType as Sr, TableViewTableWinSaveInfo as Ss, ApplyGroupStateWarning as St, FieldListObject as T, NxPivotDimensionCell as Ta, NxDownloadOptions as Ti, ExtensionList as Tn, SearchCharRange as To, LayoutFieldInfo as Tr, TransformAppParameters as Ts, ArrayOfNxValuePoint as Tt, GenericVariable as U, NxTreeDimensionDef as Ua, NxGrpType as Ui, FilterType as Un, SearchObjectOptions as Uo, NativeGlobalFunctions as Ur, CharEncodingType as Ut, GenericObjectPropertiesNodeLevel5 as V, NxTickCell as Va, NxGroupObjectId as Vi, FileType as Vn, SearchMatchCombination as Vo, NativeGenericObjectFunctions as Vr, BookmarkVariableItem as Vt, UndoInfoObject as W, NxTreeDimensionInfo as Wa, NxHighlightRanges as Wi, FolderItem as Wn, SearchPage as Wo, NativeVariableFunctions as Wr, CharRange as Wt, DynamicAppViewListData as X, NxTrendlineDef as Xa, NxLayoutErrors as Xi, GenericBookmarkProperties as Xn, SearchValuePage as Xo, NxAttrExprInfo as Xr, ContentLibraryList as Xt, DimensionListItem as Y, NxTrendline as Ya, NxLTrendlineType as Yi, GenericBookmarkLayout as Yn, SearchValueOptions as Yo, NxAttrExprDef as Yr, Connection as Yt, DynamicAppViewListItem as Z, NxTrendlineMode as Za, NxLibraryDimension as Zi, GenericConnectMachine as Zn, SearchValueResult as Zo, NxAttributeDimValues as Zr, ContentLibraryListItem as Zt, ObjectHelperFunctions as _, NxMultiRangeSelectInfo as _a, NxDerivedFieldDescriptionList as _i, EditorBreakpoint as _n, RangeSelectInfo as _o, HyperCubeDef as _r, TableViewBroomPointSaveInfo as _s, AppEntry as _t, AppSession as a, NxLocalizedWarningCode as aa, NxCell as ai, DatabaseInfo as an, OtherLimitMode as ao, GenericObjectLayoutAdditionalProperties as ar, StateFieldValues as as, ODAGAppLinkListData as at, Global as b, NxPageTreeLevel as ba, NxDimCellType as bi, ErrorData as bn, SampleResult as bo, InteractDef as br, TableViewDlgSaveInfo as bs, AppScript as bt, NativeReactHooks as c, NxMeasure as ca, NxContainerEntry as ci, DerivedFieldsInTableData as cn, OtherTotalSpecProp as co, GenericVariableConstraints as cr, StaticContentUrl as cs, SheetListDataCell as ct, WorkloadType as d, NxMetaDef as da, NxContinuousRangeSelectInfo as di, DimensionReference as dn, ProgressData as do, GenericVariableType as dr, StringExpression as ds, StoryListData as dt, NxLibraryMeasureDef as ea, NxAxisData as ei, DataField as en, NxVariableProperties as eo, GenericDimensionProperties as er, SelectionObjectDef as es, ListItem as et, CombinedWebSocketStateEvent as f, NxMiniChart as fa, NxCurrentSelectionItem as fi, DoReloadExParams as fn, ProgressMessage as fo, GraphMode as fr, SymbolFrequency as fs, StoryListItem as ft, ModalFunctions as g, NxMiniChartRows as ga, NxDerivedField as gi, DriveType as gn, QRange as go, HyperCube as gr, TableRow as gs, AlternateStateData as gt, ListFunctions as h, NxMiniChartDef as ha, NxDataReductionMode as hi, DriveInfo as hn, QMediaList as ho, GroupStateInfo as hr, TableRecord as hs, AlfaNumString as ht, withHostConfig as i, NxLocalizedErrorCode as ia, NxCardinalities as ii, Database as in, OleDbProvider as io, GenericObjectLayout as ir, StateEnumType as is, MeasureListItem as it, GenericObjectLayoutNode as j, NxSelectionCellType as ja, NxFieldProperties as ji, FieldDescription as jn, SearchFieldMatchesItem as jo, MeasureList as jr, UsageEnum as js, Bookmark as jt, GenericMeasure as k, NxRangeSelectInfo as ka, NxFeature as ki, FieldAttributes as kn, SearchFieldMatch as ko, LocaleInfo as kr, UndoInfo as ks, BNFType as kt, OpenAppSessionProps as l, NxMeasureInfo as la, NxContinuousDataOptions as li, DimensionList as ln, Point as lo, GenericVariableLayout as lr, StaticContentUrlDef as ls, SheetListDataCellBounds as lt, Doc as m, NxMiniChartData as ma, NxDataPage as mi, DocListEntry as mn, QIX_SCHEMA_VERSION as mo, GroupState as mr, TableProfilingData as ms, VariableListItem as mt, openAppSession as n, NxListObjectExpression as na, NxBookmark as ni, DataTable as nn, ObjectInterface as no, GenericMeasureProperties as nr, SortCriteria as ns, MasterObjectListItem as nt, CloseProps as o, NxMatchingFieldInfo as oa, NxCellPosition as oi, DatabaseOwner as on, OtherMode as oo, GenericObjectProperties as or, StaticContentList as os, ODAGAppLinkListItem as ot, WebSocketEvent as p, NxMiniChartCell as pa, NxDataAreaPage as pi, DoReloadExResult as pn, QFunction as po, GroupBookmarkData as pr, SymbolValue as ps, VariableListData as pt, BookmarkListItem as q, NxTreeRangeSelectInfo as qa, NxInlineDimensionDef as qi, FunctionGroup as qn, SearchSuggestionResult as qo, NxAttrDimDef as qr, CodePage as qt, qix as r, NxListObjectExpressionDef as ra, NxCalcCond as ri, DataTableEx as rn, OdbcDsn as ro, GenericObjectEntry as rr, SourceKeyRecord as rs, MeasureListData as rt, DocAction as s, NxMatchingFieldMode as sa, NxCellRows as si, DelimiterInfo as sn, OtherSortMode as so, GenericObjectPropertiesAdditionalProperties as sr, StaticContentListItem as ss, SheetListData as st, QixAPI as t, NxLinkedObjectInfo as ta, NxAxisTicks as ti, DataRecord as tn, NxViewPort as to, GenericMeasureLayout as tr, Size as ts, MasterObjectListData as tt, UseAppHook as u, NxMeta as ua, NxContinuousMode as ui, DimensionListDef as un, PositionMark as uo, GenericVariableProperties as ur, StringExpr as us, SheetListItem as ut, SpecialObjectFunctions as v, NxOrigin as va, NxDerivedFieldsData as vi, EmbeddedSnapshot as vn, Rect as vo, InputFieldItem as vr, TableViewConnectionPointSaveInfo as vs, AppObjectList as vt, Field as w, NxPatches as wa, NxDownloadInfo as wi, ExtendedPivotStateData as wn, SearchAttribute as wo, LayoutExclude as wr, TotalMode as ws, ApplyGroupStatesResult as wt, AnyGenericObjectLayout as x, NxPageTreeNode as xa, NxDimension as xi, ErrorDataCode as xn, ScriptSyntaxError as xo, InteractType as xr, TableViewSaveInfo as xs, AppScriptMeta as xt, StandardFunctions as y, NxPage as ya, NxDerivedGroup as yi, EmbeddedSnapshotDef as yn, ReloadError as yo, InterFieldSortData as yr, TableViewCtlSaveInfo as ys, AppObjectListDef as yt, GenericObjectPropertiesNodeLevel3 as z, NxStreamListEntry as za, NxGroupDef as zi, FieldValue as zn, SearchGroupOptions as zo, NativeGenericDimensionFunctions as zr, BookmarkListDef as zt };