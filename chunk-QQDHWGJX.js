...
async function invokeFetch(api, props) {
  ...
  return (await _chunkERGV34M7js.getInvokeFetchRuntimeModule.call(void 0, hostConfig)).invokeFetch(api, props);
}
function clearApiCache(api) {
  void _chunkERGV34M7js.getInvokeFetchRuntimeModule.call(void 0, ).then((runtimeModule) => runtimeModule.clearApiCache(api));
}
