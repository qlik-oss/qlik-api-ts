...
var _MZIYRPC7js = require('./chunks/MZIYRPC7.js');
...
function apiDefToApi(namespace, def) {
  ...
  const api2 = {
    clearCache: () => _DMU5PHUVjs.clearApiCache.call(void 0, namespace)
  };
  const initFunc = () => {
...
function createClassicApiFn(namespace, operationName, pathTemplate, method, argNames, hasQuery, hasBody, contentType, useInstead) {
  return (...args) => {
    ...
    return _DMU5PHUVjs.invokeFetch.call(void 0, namespace, {
      method,
      pathTemplate,
      pathVariables,
      query,
...
var auth = _46XPPLVJjs.auth_default;
...
var qix = _MZIYRPC7js.qix_default;
