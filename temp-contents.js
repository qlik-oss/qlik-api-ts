...
var uploadTempFile = async (query, body, options) => _LHCJKIEOjs.invokeFetch.call(void 0, "temp-contents", {
  method: "post",
...
var downloadTempFile = async (id, query, options) => _LHCJKIEOjs.invokeFetch.call(void 0, "temp-contents", {
  method: "get",
...
var getTempFileDetails = async (id, options) => _LHCJKIEOjs.invokeFetch.call(void 0, "temp-contents", {
  method: "get",
...
function clearCache() {
  return _LHCJKIEOjs.clearApiCache.call(void 0, "temp-contents");
}
