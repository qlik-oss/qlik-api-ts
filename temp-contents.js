...
var uploadTempFile = async (query, body, options) => _chunkWA4O4PMUjs.invokeFetch.call(void 0, "temp-contents", {
  method: "post",
...
var downloadTempFile = async (id, query, options) => _chunkWA4O4PMUjs.invokeFetch.call(void 0, "temp-contents", {
  method: "get",
...
var getTempFileDetails = async (id, options) => _chunkWA4O4PMUjs.invokeFetch.call(void 0, "temp-contents", {
  method: "get",
...
function clearCache() {
  return _chunkWA4O4PMUjs.clearApiCache.call(void 0, "temp-contents");
}
