...
var uploadTempFile = async (query, body, options) => _PTU5VIWSjs.invokeFetch.call(void 0, "temp-contents", {
  method: "post",
...
var downloadTempFile = async (id, query, options) => _PTU5VIWSjs.invokeFetch.call(void 0, "temp-contents", {
  method: "get",
...
var getTempFileDetails = async (id, options) => _PTU5VIWSjs.invokeFetch.call(void 0, "temp-contents", {
  method: "get",
...
function clearCache() {
  return _PTU5VIWSjs.clearApiCache.call(void 0, "temp-contents");
}
