...
var uploadTempFile = async (query, body, options) => _DMU5PHUVjs.invokeFetch.call(void 0, "temp-contents", {
  method: "post",
...
var downloadTempFile = async (id, query, options) => _DMU5PHUVjs.invokeFetch.call(void 0, "temp-contents", {
  method: "get",
...
var getTempFileDetails = async (id, options) => _DMU5PHUVjs.invokeFetch.call(void 0, "temp-contents", {
  method: "get",
...
function clearCache() {
  return _DMU5PHUVjs.clearApiCache.call(void 0, "temp-contents");
}
