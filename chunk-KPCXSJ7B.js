...
async function invokeFetch(api, props) {
  ...
  return (await _chunkZXQHFWQHjs.getInvokeFetchRuntimeModule.call(void 0, hostConfig)).invokeFetch(api, props);
}
function clearApiCache(api) {
  void _chunkZXQHFWQHjs.getInvokeFetchRuntimeModule.call(void 0, ).then((runtimeModule) => runtimeModule.clearApiCache(api));
}
