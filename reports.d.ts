...
export type Visualization = {
  ...
  patches?: NxPatch[];
  /** Choose visualization to export an image of a sense chart, sessionobject for a visualization to be created on-the-fly, sheet to export a sheet as a whole image. An empty value leads to the type being inferred by its id. */
  type?: "visualization" | "sessionobject" | "sheet";
  /** Width in pixels. */
  widthPx: number;
};
/**
