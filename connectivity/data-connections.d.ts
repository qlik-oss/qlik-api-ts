...
export type PatchRequest = {
  ...
  /** JSON Pointer path to the field to patch. */
  path: string;
...
export declare function getDataConnections(query: {
  ...
  sort?: "+_id" | "-_id" | "+qName" | "-qName" | "+created" | "-created" | "+updated" | "-updated";
 ...
 */
export declare function duplicateDataConnections(body: ActionDuplicateRequest, options?: ApiCallOptions): Promise<DuplicateDataConnectionsHttpResponse>;
export type DuplicateDataConnectionsHttpResponse = {
  data: ConnectionCreateResponse;
  headers: Headers;
  status: 201;
};
export type DuplicateDataConnectionsHttpError = {
  data: ResponseErrors;
  headers: Headers;
  status: 400 | 403 | 404 | 409;
};
...
export declare function getDataConnection(qID: string, query: {
  ...
  /** When `true`, returns an extended set of properties, including the encrypted credential string. */
  extended?: boolean;
  /** When `true`, bypasses the cache and returns the most up-to-date data file connections. By default, datafile connections may be served from cache. */
  noCache?: boolean;
  /** When `true`, includes a list of parsed connection properties in the response. Default is `false`. */
...
//#endregion
export { dataConnectionsExport as default, data_connections_d_exports as t };