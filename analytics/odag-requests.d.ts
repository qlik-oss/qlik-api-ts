 ...
 */
export type ReloadAppPayloadV2 = {
 ...
 */
export type RenameAppPayloadV2 = {
 ...
 */
export type RequestAction = "cancel" | "pause" | "resume" | "ackcancel" | "ackfailure";
/**
 ...
 */
export declare function getOdagRequest(requestId: string, options?: ApiCallOptions): Promise<GetOdagRequestHttpResponse>;
export type GetOdagRequestHttpResponse = {
  data: RequestObjectV2;
  headers: Headers;
  status: 200;
};
export type GetOdagRequestHttpError = {
  data: ErrorV2;
  headers: Headers;
  status: 403 | 404;
};
 ...
 */
export declare function updateOdagRequest(requestId: string, query: {
...
export type UpdateOdagRequestHttpResponse = {
  data: RequestObjectV2;
  headers: Headers;
  status: 200;
};
export type UpdateOdagRequestHttpError = {
  data: ErrorV2;
  headers: Headers;
  status: 403 | 404;
};
 ...
 */
export declare function deleteOdagRequestApp(requestId: string, options?: ApiCallOptions): Promise<DeleteOdagRequestAppHttpResponse>;
export type DeleteOdagRequestAppHttpResponse = {
  data: void;
  headers: Headers;
  status: 204;
};
export type DeleteOdagRequestAppHttpError = {
  data: ErrorV2;
  headers: Headers;
  status: 403 | 404;
};
 ...
 */
export declare function createOdagRequestReloadApp(requestId: string, body: ReloadAppPayloadV2, options?: ApiCallOptions): Promise<CreateOdagRequestReloadAppHttpResponse>;
export type CreateOdagRequestReloadAppHttpResponse = {
  data: RequestObjectV2;
  headers: Headers;
  status: 200;
};
export type CreateOdagRequestReloadAppHttpError = {
  data: ErrorV2;
  headers: Headers;
  status: 403 | 404;
};
 ...
 */
export declare function createOdagRequestRenameApp(requestId: string, body: RenameAppPayloadV2, options?: ApiCallOptions): Promise<CreateOdagRequestRenameAppHttpResponse>;
export type CreateOdagRequestRenameAppHttpResponse = {
  data: RequestObjectV2;
  headers: Headers;
  status: 200;
};
export type CreateOdagRequestRenameAppHttpError = {
  data: ErrorV2;
  headers: Headers;
  status: 403 | 404;
};
 ...
 */
export declare function getOdagRequestSelections(requestId: string, options?: ApiCallOptions): Promise<GetOdagRequestSelectionsHttpResponse>;
export type GetOdagRequestSelectionsHttpResponse = {
  data: SelectionStateV2;
  headers: Headers;
  status: 200;
};
export type GetOdagRequestSelectionsHttpError = {
  data: ErrorV2;
  headers: Headers;
  status: 403 | 404;
};
...
//#endregion
export { odagRequestsExport as default, odag_requests_d_exports as t };